...
<a href="https://autograder.cse.buffalo.edu/courses/CSE442-s22-real/assessments">
  <autolab> Submit Lecture Assignments and in-class activities</autolab>
</a>
</ul>
...
<ul>
<a href="">
  <IBM> IBM Cloud Access for some selective projects (TBD) </IBM>
</a>
</ul>
...
<table>
  ...
  <tr>
    <td>Sprint 1 - Project Progress and Demos</td>
    <td>15%</td>
  </tr>
  <tr>
    <td>Sprint 2 Project Progress and Demos</td>
    <td>20%</td>
  </tr>
  <tr>
    <td>Sprint 3 Project Progress and Demos</td>
    <td>20%</td>
  </tr>
  <tr>
    <td>Sprint 4 Project Progress and Demos</td>
    <td>20%</td>
  </tr>
  <tr>
    <td>Final Project Reports, Demos, and recorded Videos</td>
    <td>10%</td>
  </tr>
  <tr>
    <td>In-class Activities and Assignments</td>
    <td>10%</td>
  </tr>
</table>
...
<p style='font-size:18px; text-align:justify'>
At the end of each sprint, students will be able to complete a peer- and self-evaluation. These evaluations provide feedback on
...
saved as a PDF file and submitted via AutoLab. Since these activities and assignment will also be used to assess department-level student
...
- Due on **March 20** for Sprint 2 project progress and demos (all codes checked-in), and the same checked-in demos will be shown to PMs in the following week  during your respective recitation  (20%) 
- Due on **April 17** for Sprint 3 project progress and demos (all codes checked-in), and the same checked-in demos will be shown to PMs in the following week  during your respective recitation  (20%) 
- Due on **May 8** for Sprint 4 project progress and demos (all codes checked-in), and the same checked-in demos will be shown to PMs in the final week  during the final examination time (for conflicting teams - a special time can be arranged individually with PMs)  (20%)
